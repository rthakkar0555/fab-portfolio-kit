...
const Dock = () => {
  ...
  const dockItems = [
    ...
    { name: "About", icon: User, href: "#skills", section: "skills" },
    { name: "Projects", icon: Code, href: "#projects", section: "projects" },
    { name: "Education", icon: Briefcase, href: "#education", section: "education" },
    { name: "Awards", icon: Award, href: "#awards", section: "awards" },
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className={`dock-item p-3 rounded-xl transition-all duration-300 ${
                  isActive 
