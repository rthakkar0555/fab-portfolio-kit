  ...
  return <section id="projects" className="py-20 bg-gradient-card">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {projects.map((project, index) => <Card key={index} className="bg-card/50 backdrop-blur-sm border-primary/10 hover:shadow-elegant transition-all duration-300 group">
              <CardHeader>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {project.technologies.map((tech, techIndex) => <Badge key={techIndex} variant="secondary" className="text-xs bg-primary/5 text-primary border-primary/20">
                          {tech}
                        </Badge>)}
                    </div>
                  </div>
